...
public:
    ...
    void call_add_paint_function( int num_display_window, void *paint_function, void *data );
...
signals:
    void sig_add_paint_function( int, void *, void * );
    void sig_rm_paint_functions( int );
    void sig_update_disp_widget( int );
public slots: // must be called in main_thread
    void add_paint_function( int num_display_window, void *paint_function, void *data );
