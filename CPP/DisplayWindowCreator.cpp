...
DisplayWindowCreator::DisplayWindowCreator() {
    ...
    connect( this, SIGNAL(sig_add_paint_function( int, void *, void * )), this, SLOT(add_paint_function( int, void *, void * )) );
...
void DisplayWindowCreator::call_add_paint_function( int num_display_window, void *paint_function, void *data ) {
    at_least_one_window_was_created = true;
    emit sig_add_paint_function( num_display_window, paint_function, data );
}
...
void DisplayWindowCreator::add_paint_function( int num_display_window, void *paint_function, void *data ) {
    ...
    display_windows[ num_display_window ]->add_paint_function( paint_function, data );
}
