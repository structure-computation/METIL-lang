...
void get_primitives_DisplayWindow( std::vector<PrimitiveClass> &primitive_classes, std::vector<PrimitiveFunction> &primitive_functions ) {
    primitive_classes.push_back( PrimitiveClass( "DisplayWindow_", "DisplayWindowPtr" ) );
    
    primitive_functions.push_back( PrimitiveFunction( "init", "th->display_window_creator->make_new_window( &self, a, b );" ).M("DisplayWindow_").A(/*nb dim*/"Int32").A(/*paint_function*/"UntypedPtr") );
    ...
    // primitive_functions.push_back( PrimitiveFunction( "destroy", "self->deleteLater();" ).M("DisplayWindow_") );
}
